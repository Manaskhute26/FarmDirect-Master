      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="mt-4 text-lg text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
            Discover peak-harvest produce carefully selected for you. Farming in harmony with nature's cycles guarantees the freshest, most flavorful ingredients.
          </p>
        </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="flex items-center gap-3 mb-2 text-white/90">
                        <Icon size={24} />
                        <span className="text-sm font-bold uppercase tracking-wider">Harvest</span>
                      </div>
                      <h2 className="text-4xl font-bold text-white mb-2">{season.name}</h2>
                      <p className="text-slate-200 text-sm max-w-sm">{season.desc}</p>
                    </div>
