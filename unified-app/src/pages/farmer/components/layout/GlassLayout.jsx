...
const GlassSidebar = ({ isMobile, onClose }) => {
  ...
  const navItems = [
    ...
    { icon: Package, label: 'My Products', path: '/farmer/inventory' },
    { icon: ClipboardList, label: 'Orders', path: '/farmer/orders' },
    { icon: DollarSign, label: 'Earnings', path: '/farmer/earnings' },
    { icon: Star, label: 'Reviews', path: '/farmer/reviews' },
    { icon: User, label: 'Farm Profile', path: '/farmer/profile' },
